...
<head>
    ...
    <?php if($count==80){ ?>
        <a href="http://1.shnupartner.sinaapp.com/library/more3.php?sch_url=<?php echo $_GET[sch_url] ?>&type=<?php echo $_GET[type] ?>&key=<?php echo $_GET[key]; ?>" target="_blank"><button><center>下一页</center></button></a>
    <?php }?>
</html>